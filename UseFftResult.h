...
/**************************************************
**************************************************/
class USE_FFT_RESULT : public ofThread{
private:
	/****************************************
	****************************************/
	enum{
	...
	********************/
	...
	ofVbo Vbo[NUM_FFT_GRAPHS];
	vector<ofVec3f> VboVerts[NUM_FFT_GRAPHS];
	vector<ofFloatColor> VboColor[NUM_FFT_GRAPHS];
